...
<%
    ...
    // 6.2: Validate student code pattern (2 uppercase letters + 3+ digits)
    String studentCodePattern = "^[A-Z]{2}[0-9]{3,}$";
    if (!studentCode.matches(studentCodePattern)) {
        response.sendRedirect("add_student.jsp?error=Invalid student code format. Use pattern: 2 uppercase letters + 3+ digits (e.g., SV001)");
        return;
    }
